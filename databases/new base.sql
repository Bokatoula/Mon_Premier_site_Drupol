...
CREATE DATABASE IF NOT EXISTS `drupal` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `drupal`;
...
-- Les données exportées n'étaient pas sélectionnées.
-- Export de la structure de la table drupal. cache_variable
...
CREATE TABLE IF NOT EXISTS `cck_field_settings` (
  ...
  `setting_option` mediumtext DEFAULT NULL COMMENT 'The custom value for this setting.'
...
CREATE TABLE IF NOT EXISTS `file_display` (
  ...
  `settings` longblob DEFAULT NULL COMMENT 'A serialized array of name value pairs that store the formatter settings for the display.',
  PRIMARY KEY (`name`)
...
CREATE TABLE IF NOT EXISTS `file_metadata` (
  ...
  `value` longblob DEFAULT NULL COMMENT 'The value of the metadata (e.g. ’200px’).',
...
CREATE TABLE IF NOT EXISTS `file_type` (
  ...
  `mimetypes` longblob DEFAULT NULL COMMENT 'Mimetypes mapped to this file type.',
  PRIMARY KEY (`type`)
...
CREATE TABLE IF NOT EXISTS `flexslider_optionset` (
  ...
  `options` longblob DEFAULT NULL COMMENT 'The options array.',
  PRIMARY KEY (`name`)
...
) ENGINE=InnoDB AUTO_INCREMENT=444 DEFAULT CHARSET=utf8 COMMENT='Contains the individual links within a menu.';
...
CREATE TABLE IF NOT EXISTS `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.';
...
-- Les données exportées n'étaient pas sélectionnées.
-- Export de la structure de la table drupal. variable_store
...
) ENGINE=InnoDB AUTO_INCREMENT=1914 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
